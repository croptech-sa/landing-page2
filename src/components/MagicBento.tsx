...
const DEFAULT_GLOW_COLOR = "55, 113, 56"; // #377138 in RGB
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
          const baseClassName = `bento-card ${card.size === 'large' ? 'bento-card--large' : 'bento-card--small'} ${textAutoHide ? "bento-card--text-autohide" : ""} ${enableBorderGlow ? "bento-card--border-glow" : ""}`;
          const cardProps = {
